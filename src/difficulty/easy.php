...
<div class="container">
<header>
<h2>XSS-STORAGE</h2><label id="difficulty">(Easy)</label>
</header>
<body>

<div id="inputs">
<input type="text" id="inp" name="code" maxlength="400" autocomplete="off">
</div>
<div id="mostrar">
<?php
...
$valor_mostrar = $valor . htmlspecialchars($valor);

echo "<font color='#5b7aff'>[$n]</font> $valor_mostrar<br>";
$n++;
}
echo "</tr>";
}
...
if (preg_match('/<script[^>]*>/i', $code)) {
    ...
    echo "<p>No hay etiquetas <script> en el codigo.";
}
